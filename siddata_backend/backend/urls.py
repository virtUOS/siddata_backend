...
urlpatterns = [
    ...
    # API 2.0
    path('api/student', api_views.student),
    path('api/recommender', api_views.recommender),
    path('api/recommender/<str:recommender_id>', api_views.recommender),
    path('api/goal', api_views.goal),
    path('api/goal/<str:goal_id>', api_views.goal),
    path('api/activity', api_views.activity),
    path('api/activity/<str:activity_id>', api_views.activity),


    path('api/coursemembership', api_views.coursemembership),
    path('api/institutemembership', api_views.institutemembership),
    path('api/studycourse', api_views.studycourse),
    path('api/studycourse/<str:studycourse_origin_id>', api_views.studycourse),
    path('api/subject', api_views.subject),
    path('api/degree', api_views.degree),
    path('api/course', api_views.course),
    path('api/course/<str:course_origin_id>', api_views.course),
    path('api/event', api_views.event),
    path('api/institute', api_views.institute),
    path('api/person', api_views.person),
